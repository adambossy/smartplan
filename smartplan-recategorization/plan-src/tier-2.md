...
- Channels where purpose isn't knowable from the descriptor get a single stable identity per counterparty or location.
- The extraction logic is reviewable and versioned, and its quality is proven before it is trusted with real data.
